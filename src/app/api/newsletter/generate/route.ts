    ...
    return `
          <tr>
            <td style="padding:24px 40px 0 40px;">
              ...
              <a href="${e(article.link)}" target="_blank" style="text-decoration:none;color:#1a1a1a;font-family:Georgia,'Times New Roman',serif;font-size:20px;font-weight:700;line-height:1.35;display:block;margin-bottom:10px;">
                ${e(article.title)}
              </a>
              <table role="presentation" cellspacing="0" cellpadding="0" style="margin-bottom:14px;">
                ${formatBullets(article.summary)}
              </table>
              <a href="${e(article.link)}" target="_blank" style="display:inline-block;padding:8px 18px;background-color:#1a1a1a;color:#ffffff;font-size:12px;font-weight:700;letter-spacing:0.5px;text-decoration:none;border-radius:4px;">
                기사읽기 →
              </a>
            </td>
          </tr>
...
function renderMadeleineItem(item: MadeleineNews): string {
    return `
        ...
        : `<p style="color:#1a1a1a;font-family:Georgia,'Times New Roman',serif;font-size:16px;font-weight:700;margin:0 0 6px 0;">${e(item.title)}</p>`
                  ...
                  <p style="color:#4a4a4a;font-size:14px;line-height:1.6;margin:0 0 10px 0;">${e(item.content)}</p>
                  ${item.link ? `
                  <a href="${e(item.link)}" target="_blank" style="display:inline-block;padding:7px 16px;background-color:#1a1a1a;color:#ffffff;font-size:12px;font-weight:700;letter-spacing:0.5px;text-decoration:none;border-radius:4px;">
                    더보기 →
                  </a>` : ''}
                </td>
              </tr>
